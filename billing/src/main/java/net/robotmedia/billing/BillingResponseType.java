...
enum BillingResponseType {
	...
	IN_APP_NOTIFY {
		@Override
		protected void doAction(@Nonnull Context context, @Nonnull Intent intent) {
	...
	protected abstract void doAction(@Nonnull Context context, @Nonnull Intent intent);
	...
	@Nullable
	static BillingResponseType fromIntentAction(@Nonnull Intent intent) {
